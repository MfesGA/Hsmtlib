...
instance ToJSON Config where
 toJSON (Config tPath tArgs tDefaultMode tAvaliableModes) =
    object[ "path" .= tPath
          , "args" .= tArgs
          , "defaultMode" .= tDefaultMode
          , "avaliableModes" .= tAvaliableModes
          ]
...
chAvailableModes c available_modes_n =
    Config { path = path c
           , args = args c
           , defaultMode = defaultMode c
...
genconfig (path_n, args_n, defaultMode_n, avaliableModes_n) =
    Config { path = path_n
           , args = args_n
           , defaultMode = defaultMode_n
